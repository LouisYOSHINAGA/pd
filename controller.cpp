...
tresult PLUGIN_API PDController::initialize(FUnknown* context){
    ...
    // DCO EG Level & Rate
    Parameter* dcoEgLR;
    dcoEgLR = new Parameter(STR16("DCO EG Rate 1"), PARAM_ID_DCO_EG_RATE_0);
    parameters.addParameter(dcoEgLR);
    dcoEgLR = new Parameter(STR16("DCO EG Lvl 1"), PARAM_ID_DCO_EG_LVL_0);
    parameters.addParameter(dcoEgLR);
    dcoEgLR = new Parameter(STR16("DCO EG Rate 2"), PARAM_ID_DCO_EG_RATE_1);
    parameters.addParameter(dcoEgLR);
    dcoEgLR = new Parameter(STR16("DCO EG Lvl 2"), PARAM_ID_DCO_EG_LVL_1);
    parameters.addParameter(dcoEgLR);
    dcoEgLR = new Parameter(STR16("DCO EG Rate 3"), PARAM_ID_DCO_EG_RATE_2);
    parameters.addParameter(dcoEgLR);
    dcoEgLR = new Parameter(STR16("DCO EG Lvl 3"), PARAM_ID_DCO_EG_LVL_2);
    parameters.addParameter(dcoEgLR);
    dcoEgLR = new Parameter(STR16("DCO EG Rate 4"), PARAM_ID_DCO_EG_RATE_3);
    parameters.addParameter(dcoEgLR);
    dcoEgLR = new Parameter(STR16("DCO EG Lvl 4"), PARAM_ID_DCO_EG_LVL_3);
    parameters.addParameter(dcoEgLR);
    dcoEgLR = new Parameter(STR16("DCO EG Rate 5"), PARAM_ID_DCO_EG_RATE_4);
    parameters.addParameter(dcoEgLR);
    dcoEgLR = new Parameter(STR16("DCO EG Lvl 5"), PARAM_ID_DCO_EG_LVL_4);
    parameters.addParameter(dcoEgLR);
    dcoEgLR = new Parameter(STR16("DCO EG Rate 6"), PARAM_ID_DCO_EG_RATE_5);
    parameters.addParameter(dcoEgLR);
    dcoEgLR = new Parameter(STR16("DCO EG Lvl 6"), PARAM_ID_DCO_EG_LVL_5);
    parameters.addParameter(dcoEgLR);
    dcoEgLR = new Parameter(STR16("DCO EG Rate 7"), PARAM_ID_DCO_EG_RATE_6);
    parameters.addParameter(dcoEgLR);
    dcoEgLR = new Parameter(STR16("DCO EG Lvl 7"), PARAM_ID_DCO_EG_LVL_6);
    parameters.addParameter(dcoEgLR);
    dcoEgLR = new Parameter(STR16("DCO EG Rate 8"), PARAM_ID_DCO_EG_RATE_7);
    parameters.addParameter(dcoEgLR);
    ...
    // DCW EG Level & Rate
    Parameter* dcwEgLR;
    dcwEgLR = new Parameter(STR16("DCW EG Rate 1"), PARAM_ID_DCW_EG_RATE_0);
    parameters.addParameter(dcwEgLR);
    dcwEgLR = new Parameter(STR16("DCW EG Lvl 1"), PARAM_ID_DCW_EG_LVL_0);
    parameters.addParameter(dcwEgLR);
    dcwEgLR = new Parameter(STR16("DCW EG Rate 2"), PARAM_ID_DCW_EG_RATE_1);
    parameters.addParameter(dcwEgLR);
    dcwEgLR = new Parameter(STR16("DCW EG Lvl 2"), PARAM_ID_DCW_EG_LVL_1);
    parameters.addParameter(dcwEgLR);
    dcwEgLR = new Parameter(STR16("DCW EG Rate 3"), PARAM_ID_DCW_EG_RATE_2);
    parameters.addParameter(dcwEgLR);
    dcwEgLR = new Parameter(STR16("DCW EG Lvl 3"), PARAM_ID_DCW_EG_LVL_2);
    parameters.addParameter(dcwEgLR);
    dcwEgLR = new Parameter(STR16("DCW EG Rate 4"), PARAM_ID_DCW_EG_RATE_3);
    parameters.addParameter(dcwEgLR);
    dcwEgLR = new Parameter(STR16("DCW EG Lvl 4"), PARAM_ID_DCW_EG_LVL_3);
    parameters.addParameter(dcwEgLR);
    dcwEgLR = new Parameter(STR16("DCW EG Rate 5"), PARAM_ID_DCW_EG_RATE_4);
    parameters.addParameter(dcwEgLR);
    dcwEgLR = new Parameter(STR16("DCW EG Lvl 5"), PARAM_ID_DCW_EG_LVL_4);
    parameters.addParameter(dcwEgLR);
    dcwEgLR = new Parameter(STR16("DCW EG Rate 6"), PARAM_ID_DCW_EG_RATE_5);
    parameters.addParameter(dcwEgLR);
    dcwEgLR = new Parameter(STR16("DCW EG Lvl 6"), PARAM_ID_DCW_EG_LVL_5);
    parameters.addParameter(dcwEgLR);
    dcwEgLR = new Parameter(STR16("DCW EG Rate 7"), PARAM_ID_DCW_EG_RATE_6);
    parameters.addParameter(dcwEgLR);
    dcwEgLR = new Parameter(STR16("DCW EG Lvl 7"), PARAM_ID_DCW_EG_LVL_6);
    parameters.addParameter(dcwEgLR);
    dcwEgLR = new Parameter(STR16("DCW EG Rate 8"), PARAM_ID_DCW_EG_RATE_7);
    parameters.addParameter(dcwEgLR);
    ...
    // DCA EG Level & Rate
    Parameter* dcaEgLR;
    dcaEgLR = new Parameter(STR16("DCA EG Rate 1"), PARAM_ID_DCA_EG_RATE_0);
    parameters.addParameter(dcaEgLR);
    dcaEgLR = new Parameter(STR16("DCA EG Lvl 1"), PARAM_ID_DCA_EG_LVL_0);
    parameters.addParameter(dcaEgLR);
    dcaEgLR = new Parameter(STR16("DCA EG Rate 2"), PARAM_ID_DCA_EG_RATE_1);
    parameters.addParameter(dcaEgLR);
    dcaEgLR = new Parameter(STR16("DCA EG Lvl 2"), PARAM_ID_DCA_EG_LVL_1);
    parameters.addParameter(dcaEgLR);
    dcaEgLR = new Parameter(STR16("DCA EG Rate 3"), PARAM_ID_DCA_EG_RATE_2);
    parameters.addParameter(dcaEgLR);
    dcaEgLR = new Parameter(STR16("DCA EG Lvl 3"), PARAM_ID_DCA_EG_LVL_2);
    parameters.addParameter(dcaEgLR);
    dcaEgLR = new Parameter(STR16("DCA EG Rate 4"), PARAM_ID_DCA_EG_RATE_3);
    parameters.addParameter(dcaEgLR);
    dcaEgLR = new Parameter(STR16("DCA EG Lvl 4"), PARAM_ID_DCA_EG_LVL_3);
    parameters.addParameter(dcaEgLR);
    dcaEgLR = new Parameter(STR16("DCA EG Rate 5"), PARAM_ID_DCA_EG_RATE_4);
    parameters.addParameter(dcaEgLR);
    dcaEgLR = new Parameter(STR16("DCA EG Lvl 5"), PARAM_ID_DCA_EG_LVL_4);
    parameters.addParameter(dcaEgLR);
    dcaEgLR = new Parameter(STR16("DCA EG Rate 6"), PARAM_ID_DCA_EG_RATE_5);
    parameters.addParameter(dcaEgLR);
    dcaEgLR = new Parameter(STR16("DCA EG Lvl 6"), PARAM_ID_DCA_EG_LVL_5);
    parameters.addParameter(dcaEgLR);
    dcaEgLR = new Parameter(STR16("DCA EG Rate 7"), PARAM_ID_DCA_EG_RATE_6);
    parameters.addParameter(dcaEgLR);
    dcaEgLR = new Parameter(STR16("DCA EG Lvl 7"), PARAM_ID_DCA_EG_LVL_6);
    parameters.addParameter(dcaEgLR);
    dcaEgLR = new Parameter(STR16("DCA EG Rate 8"), PARAM_ID_DCA_EG_RATE_7);
    parameters.addParameter(dcaEgLR);
